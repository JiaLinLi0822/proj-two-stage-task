    ...
    for (wid, subject_trials) in trials_by_wid
        ...
        for trial in subject_trials
            ...
            for sim_idx in 1:n_simulations
                ...
                correct1 = correct1(trial.best_path_idx, choice1_sim)
                correct2 = correct2(trial.value2, choice1_sim, choice2_sim)
                correct_all = correct1 && correct2
                
                subtree_relation = subtree_relation_code(trial.path)
                ...
                result_entry = Dict(
                    ...
                    "subtree_relation" => subtree_relation
                )
...
MODEL_NAME = "model6"
PARAM_FILE = "Tree1/results/pda/model6_pda_BADS_20251007_231814.csv"
