...
function get_model_configs()
    ...
    "model1" => ModelConfig(
        model1,
        Box(:d1 => log_bounds(1e-6, 1e-2),
            :d2 => log_bounds(1e-6, 1e-2), 
            :θ1 => linear_bounds(1e-3, 2.0),
            :Δ => linear_bounds(1e-3, 2.0),
            :T1 => linear_bounds(10.0, 10000.0),
            :T2 => linear_bounds(10.0, 10000.0)),
        Box(:d1 => log_bounds(1e-5, 1e-3),
            :d2 => log_bounds(1e-5, 1e-3), 
            :θ1 => linear_bounds(0.01, 1.0),
            :Δ => linear_bounds(0.01, 1.0),
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d1 => 1e-4, :d2 => 1e-4, :θ1 => 1.0, :Δ => 0.2, :T1 => 1000.0, :T2 => 1000.0),
        ["d1", "d2", "θ1", "Δ", "T1", "T2"],
        6,
    ...
    "model3" => ModelConfig(
        ...
        Dict(:d1 => 1e-4, :d2 => 1e-4, :θ1 => 1.0, :Δ => 0.2, :T1 => 1000.0, :T2 => 1000.0, :θ_prun => 0.5),
    ...
    "model5" => ModelConfig(
        model5,
        Box(:d => log_bounds(1e-6, 1e-2),
            :θ1 => linear_bounds(1e-3, 2.0),
            :Δ => linear_bounds(1e-3, 2.0),
            :T1 => linear_bounds(10.0, 10000.0),
            :T2 => linear_bounds(10.0, 10000.0)),
        Box(:d => log_bounds(1e-5, 1e-3),
            :θ1 => linear_bounds(0.01, 1.0),
            :Δ => linear_bounds(0.01, 1.0),
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d => 1e-4, :θ1 => 1.0, :Δ => 0.2, :T1 => 1000.0, :T2 => 1000.0),
        ["d", "θ1", "Δ", "T1", "T2"],
        5,
    ...
    "model6" => ModelConfig(
        ...
        Box(:d1 => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d1 => 1e-4, :d2 => 1e-4, :θ1 => 1.0, :θ2 => 0.5, :T1 => 1000.0, :T2 => 1000.0),
        ["d1", "d2", "θ1", "θ2", "T1", "T2"],
        6,
    ...
    "model7" => ModelConfig(
        model7,
        Box(:d0 => log_bounds(1e-6, 1e-2),
            :d1 => log_bounds(1e-6, 1e-2),
            :d2 => log_bounds(1e-6, 1e-2), 
            ...
            :T1 => linear_bounds(10.0, 10000.0),
            :T2 => linear_bounds(10.0, 10000.0)),
        Box(:d0 => log_bounds(1e-5, 1e-3),
            :d1 => log_bounds(1e-5, 1e-3),
            :d2 => log_bounds(1e-5, 1e-3), 
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d0 => 1e-4, :d1 => 1e-4, :d2 => 1e-4, :θ0 => 0.4, :θ1 => 0.5, :θ2 => 0.8, :T1 => 1000.0, :T2 => 1000.0),
    ...
    "model8" => ModelConfig(
        ...
        Box(:d0 => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d0 => 1e-4, :d2 => 1e-4, :θ0 => 0.5, :θ2 => 0.8, :T1 => 1000.0, :T2 => 1000.0),
        ["d0", "d2", "θ0", "θ2", "T1", "T2"],
        6,
    ...
    "model11" => ModelConfig(
        ...
        Box(:d => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d => 1e-4, :θ0 => 0.6, :vigor1 => 1.0, :vigor2 => 1.2, :T1 => 1000.0, :T2 => 1000.0),
    ...
    "model12" => ModelConfig(
        ...
        Box(:d => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d => 1e-4, :θ0 => 0.6, :vigor => 1.0, :T1 => 1000.0, :T2 => 1000.0),
        ["d", "θ0", "vigor", "T1", "T2"],
        5,
    ...
    "model13" => ModelConfig(
        ...
        Dict(:d => 1e-4, :θ0 => 0.6, :vigor1 => 1.0, :vigor2 => 1.2, :T1 => 1000.0, :T2 => 1000.0, :rating_sd => 0.1),
    ...
    "model14" => ModelConfig(
        ...
        Box(:d1 => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0)),
        Dict(:d1 => 1e-4, :d2 => 1e-4, :θ1 => 0.5, :Δ => 0.3, :T1 => 1000.0, :T2 => 1000.0),
        ["d1", "d2", "θ1", "Δ", "T1", "T2"],
        6,
    ...
    "model15" => ModelConfig(
        ...
        Box(:d1 => log_bounds(1e-5, 1e-3),
            ...
            :T1 => linear_bounds(100.0, 5000.0),
            :T2 => linear_bounds(100.0, 5000.0),
            :γ => linear_bounds(0.01, 2.0)),
        Dict(:d1 => 1e-4, :d2 => 1e-4, :θ1 => 0.5, :Δ => 0.3, :T1 => 1000.0, :T2 => 1000.0, :γ => 1.0),
        ["d1", "d2", "θ1", "Δ", "T1", "T2", "γ"],
        7,
        "Two-stage with discounting"
    )
